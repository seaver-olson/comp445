...
status_t BOARD_InitPsRam(void)
{
    ...
    uint32_t psramLUT[] = {
        ...
        [5] = FLEXSPI_LUT_SEQ(kFLEXSPI_Command_WRITE_SDR, kFLEXSPI_4PAD, 0x00, kFLEXSPI_Command_STOP, kFLEXSPI_1PAD,
                              0x00),

        /* Reset */
        [8] = FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x66, kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x99),
    };
    ...
    {
        /* Reset PSRAM */
        status = flexspi_hyper_ram_run_seq(BOARD_FLEXSPI_PSRAM, 13);
