...
################################################################################
    ...
    - Put the device to the In System Programming (ISP) mode:
        ...
        - Connect a USB-C cable between the PC host and the USB UART J21 port.
...
################################################################################
    ...
    - Connect a USB-C cable between the PC host and the J-Link/J-Trace USB UART port Link2 J21 connector on the board.
